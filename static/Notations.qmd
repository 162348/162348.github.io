...
[集合](#subsec-set)，[数](#sec-numbers)，[組](#sec-tuples)，[写像](#sec-maps)，[圏](#subsec-category)，[関数](#subsec-function)，[演算](#subsec-operation)．

## ２．空間

[位相](#subsec-topology)，[線型空間](#subsec-linear-space)，[Banach 空間](#subsec-Banach-spaces)，[可測空間](#subsec-measurable-space)，[確率空間](#sec-probability-space)，[確率分布](#subsec-distributions)

## ３．核

[測度](#subsec-measures)，[確率核](#subsec-kernels)，[関数の空間](#subsec-function-spaces)，[変形](#subsec-variants)，[作用素](#subsec-operators)

## ４．解析

[微分作用素](#subsec-differential-operators)，[Fourier 変換](#subsec-Fourier-transform)，[超関数](#subsec-generalized-functions)，[確率解析](#subsec-stochastic-analysis)

## ５．過程

[確率変数の収束](#subsec-convergence)，[確率基底](#subsec-stochastic-basis)，[可測性](#subsec-measurability)，[停止時](#subsec-stopping-time)

:::

> We could, of course, use any notation we want; do not laugh at notations; invent them, they are powerful. In fact, **mathematics is, to a large extent, invention of better notations**. <br>
> --- [The Feynman Lectures on Physics, Vol.1, Ch.17](https://www.feynmanlectures.caltech.edu/I_17.html), Sec. 5.
