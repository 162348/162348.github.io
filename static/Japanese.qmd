...
また [連続時間 MCMC](ResearchJP.qmd) を用いた事後分布サンプリングのための Julia パッケージ [PDMPFlux.jl](https://github.com/162348/PDMPFlux.jl) や，確率過程の統計推測のための R パッケージ [YUIMA](https://r-forge.r-project.org/projects/yuima/) の開発にも取り組んでおり，ベイズ統計と機械学習の応用に広く取り組んでいます．
...
2. 統計モデリング<br>
  政治学・疫学・惑星地球科学などへの応用．
3. ベイズ機械学習<br>
  カーネル法・ノンパラメトリクス・ベイジアンニューラルネットワーク．
