...
統計や機械学習で用いられる計算アルゴリズム，特にモンテカルロ法や確率的勾配降下法を専門に研究しています．
...
博士課程では，統計数理研究所 [鎌谷研吾](https://sites.google.com/view/kengokamatani/home) 先生の下，モンテカルロ法や拡散モデルなどのサンプリングアルゴリズムの理論解析に取り組んでいます．

確率過程の収束を確率測度の空間 上の幾何と関連付けて議論することで，アルゴリズムの挙動を分析する数理的な枠組みの構築を目指しています．

また [連続時間 MCMC](https://162348.github.io/static/ResearchJP.html) を用いた事後分布サンプリングのための Julia パッケージ [PDMPFlux.jl](https://github.com/162348/PDMPFlux.jl) や，確率過程の統計推測のための R パッケージ [YUIMA](https://r-forge.r-project.org/projects/yuima/) の開発にも取り組んでいます．
