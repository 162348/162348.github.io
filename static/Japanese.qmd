...
### 総合研究大学院大学５年一貫博士課程（[統計科学コース](https://www.ism.ac.jp/senkou/)）３年 {style="margin-bottom: 1em;"}


統計や機械学習，AI で用いられる計算アルゴリズム，特にモンテカルロ法や最適化法のダイナミクスに興味があり，確率過程としてみて応用数学の枠組みで研究しています．

そこで博士課程では，統計数理研究所 [鎌谷研吾](https://sites.google.com/view/kengokamatani/home) 先生の下で，特に汎用的に使われるアルゴリズムである「マルコフ連鎖モンテカルロ法」のダイナミクスの解析に取り組んでいます．

開発したアルゴリズムを [PDMPFlux.jl](https://github.com/162348/PDMPFlux.jl) や [YUIMA](https://github.com/yuimaproject/yuima) などのパッケージとして実装し，ヘルスケア・ものづくり企業へのデータ解析コンサルティングも行っています．
...
私は「ベイズ計算」と呼ばれる分野を専門にしています．

ベイズ推論は，統計学・逆問題・機械学習・情報科学・数値計算……などの幅広い分野において，確率論を応用するための統一的な枠組みです．
...
1. **モンテカルロ計算**<br>
  MCMC，SMC，拡散モデルなどのベイズ計算法．
2. **最適化**<br>
  ニューラルネットワーク・カーネル法などの推論法．
3. **モデリング**<br>
  政治学・疫学・惑星地球科学などへの応用． -->
...
[連続時間 MCMC](https://162348.github.io/static/ResearchJP.html) を新たな汎用ベイズ推論アルゴリズムとして注目しており，その計算が遅くなってしまう理由の理論的解明と，より速いアルゴリズムを提案する研究を進めています．
...
受入教員：Evgeny Spodarev<br>
支援：[Opportunity Week](https://www.uni-ulm.de/en/misc/graduate-professional-training-center-ulm/we-offer/funding/opportunity-week/)

#### [{{< fa building-columns >}}]{.color-minty} シンガポール国立大学, 2025.6.1--30

受入教員：Alexandre Thiéry<br>
支援：SOKENDAI 研究派遣プログラム

#### [{{< fa building-columns >}}]{.color-minty} ユニバーシティ・カレッジ・ロンドン, 英国, 2024.11.4--12.2

受入教員：Alexandros Beskos<br>
支援：[SOKENDAI 研究派遣プログラム](https://www.soken.ac.jp/student-research/20250214_1.html)
