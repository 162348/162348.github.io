...
#' @title HMC による適応的ベイズ推定
#' @description 
#' 
#' @param yuima yuima オブジェクト
#' @param start パラメータの初期値
#' @param priors パラメータの事前分布
#' @param upper パラメータの上限
#' @param lower パラメータの下限
#' @param iter モンテカルロサンプル数
#' @param chains 並列鎖数
#' @param refresh 進捗表示間隔
#' @param rstan 現状は意味なし
#' 
adaStan <- function(yuima, start, priors, upper, lower, iter = 4000, chains = 4,
