...
* Transport Methods (Schrödinger Bridges, Diffusion Models, etc.)
* Bayesian Modeling (Political Science, Biology, etc.)
* Bayesian Machine Learning (Kernel Methods, Gaussian Processes, etc.)
...
_[Economic Security Resarch Program](https://esrp.rcast.u-tokyo.ac.jp/experts/hirofumi-shiba/)_
