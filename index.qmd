...
- Transport Methods (Schrödinger Bridges, Interacting Particle Methods, etc.)
- Monte Carlo Computation (SMC, MCMC, etc.)
- Bayesian Modeling (Political Science, Bioinformatics, etc.)
- Bayesian Machine Learning (Gaussian Processes, Hierarchical Models, etc.)
<!-- 
- Topological Data Analysis (Diffusion Maps, Probability in Banach Spaces, etc.)
-->
