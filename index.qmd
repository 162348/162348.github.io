...
Mainly, I work on emerging sampling algorithms, such as Piecewise Deterministic Monte Carlo methods and Denoising Diffusion Models, seen from the perspective of Stochastic Process, under the supervision of <a href="https://sites.google.com/view/kengokamatani/home">Kengo Kamatani</a>.

Before pursuing a Ph.D. in Statistics, I was trained as a mathematician at the University of Tokyo.
...
<figcaption>Don't confuse Shiba (司馬), a surname, with [Shiba (柴)](https://en.wikipedia.org/wiki/Shiba_Inu) the dog. Main difference lies in the ears.</figcaption>
