...
Hello, my name is **Hirofumi Shiba**. You can call me Hiro. I am a researcher in Applied Mathematics.

I am currently a Ph.D. candidate at the [**Institute of Statistical Mathematics**](https://www.ism.ac.jp/index_e.html) (ISM) in Japan, specializing in **Bayesian Computation** under Prof. [**Kengo Kamatani**](https://sites.google.com/view/kengokamatani/home).

I am particularly focused on devising more efficient, scalable and automatic sampling algorithms, such as Markov Chain Monte Carlo (MCMC) and Sequential Monte Carlo (SMC) algorithms, by leveraging the insights from their continuous-time limits.
