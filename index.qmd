...
1. Transport Methods (Schrödinger Bridge, Interacting Particle Method, etc.)
2. Monte Carlo Computation (SMC, MCMC, PDMP, etc.)
3. Bayesian Machine Learning (Gaussian Process, Hierarchical Models etc.)
4. Bayesian Modeling (Political Science, Biostatistics, etc.)
5. Manifold Learning (Diffusion Map, Optimal Transport, etc.)
