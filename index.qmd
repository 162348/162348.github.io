...
::: {#first-column}
![](assets/face!.jpeg){width=100% fig-align="center"}
:::

::: {#second-column}
## Hello!

I'm Hiro, a 2nd year M.Sc. student jointly supervised by [Kengo Kamatani](https://sites.google.com/view/kengokamatani/home) and [Keisuke Yano](https://sites.google.com/site/kyanostat/) at the [Institute of Statistical Mathematics](https://www.ism.ac.jp/index_e.html) (ISM) in Tokyo, Japan.

<!-- I am an applied mathematician by training, now working on Computational Statistics. -->

My research focuses around stochastic / statistical algorithms. By making them more efficient, scalable, and automated, I aim to broaden the application of statistics and machine learning.
...
1. Sampling by Transportation (Schrödinger Bridge, Interacting Particle Method, etc.)
2. Monte Carlo Computation (SMC, MCMC, PDMP, etc.)
3. Bayesian Machine Learning (Gaussian Process, Nonparametrics, etc.)
4. Bayesian Modeling (Political Science, Biostatistics, etc.)
5. Data-driven Science (Diffusion Map, Trajectory Learning, etc.)
...
##### [{{< fa building-columns >}}]{.color-minty} Cooperative Researcher
