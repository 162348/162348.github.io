...
Gamma確率変数と，その返還として得るBeta確率変数とに関する
次の命題の証明を与える．

![Formula to prove](formula.png)
...
レートパラメータを固定し，形状パラメータを残した $\chi^2(k):=\GAMMA(1/2,k/2)$ を自由度 $k$ のカイ自乗分布ということに注意．
