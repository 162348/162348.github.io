...
date: "11/11/2023"
categories: [Categories, Probability]
abstract-title: 概要
...
このような精神を持ち，具体的には圏論的な方法で，確率論のもう一つのモデルを構築しようとするのが綜合的確率論(synthetic probability)である．Anders Kock と Lewvereによる綜合的微分幾何学(synthetic differential geometry)からのシリーズを意識した命名であり，数学の各分野を「圏論化」することを，「[綜合的](https://ncatlab.org/nlab/show/synthetic+mathematics)」という形容詞で捉えようとしている．
