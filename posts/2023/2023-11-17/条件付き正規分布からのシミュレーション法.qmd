...
[文献](https://www.cs.ubc.ca/~arnaud/doucet_simulationconditionalgaussian.pdf) [@Doucet2010-ConditionalGaussianSimulation] の内容に基づき，証明を与えながら，条件付きGauss分布の特定と，効率的なシミュレーション法を議論し，線型Gauss状態空間モデルのフィルタリング（特にEnsemble Kalman filter）に応用する．

![The Foudational Fact of Conditional Gaussian Simulation](formula.png)
...
$$
\begin{align*}
\Var[\ov{X}]&=\E[\Var[\ov{X}|Y]]+\underbrace{\Var[\E[\ov{X}|Y]]}_{=0}\\
&=\Sigma_{x|y}.
\end{align*}
$$
:::
