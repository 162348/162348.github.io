...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, opacityback=0, colframe=quarto-callout-important-color-frame, toprule=.15mm, left=2mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, toprule=.15mm, left=2mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, toptitle=1mm, coltitle=black, bottomrule=.15mm, colback=white, breakable, arc=.35mm, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, title={注（TeX Live のアップデート方法）}, opacityback=0, colframe=quarto-callout-important-color-frame, toprule=.15mm, left=2mm, opacitybacktitle=0.6]
