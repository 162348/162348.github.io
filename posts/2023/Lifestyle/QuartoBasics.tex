...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colback=white, colframe=quarto-callout-important-color-frame, breakable, toprule=.15mm, leftrule=.75mm, rightrule=.15mm, bottomrule=.15mm, left=2mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colback=white, colframe=quarto-callout-tip-color-frame, breakable, toprule=.15mm, leftrule=.75mm, rightrule=.15mm, bottomrule=.15mm, left=2mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, titlerule=0mm, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-important-color-frame, breakable, toprule=.15mm, leftrule=.75mm, toptitle=1mm, bottomtitle=1mm, bottomrule=.15mm, title={注（TeX Live のアップデート方法）}, arc=.35mm]
