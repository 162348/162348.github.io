...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, colframe=quarto-callout-important-color-frame, colback=white, left=2mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, breakable, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, colframe=quarto-callout-tip-color-frame, colback=white, left=2mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, breakable, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, title={注（TeX Live のアップデート方法）}, toptitle=1mm, colframe=quarto-callout-important-color-frame, left=2mm, breakable, leftrule=.75mm, coltitle=black, colback=white, bottomtitle=1mm, rightrule=.15mm, arc=.35mm, bottomrule=.15mm, titlerule=0mm, opacitybacktitle=0.6, opacityback=0, colbacktitle=quarto-callout-important-color!10!white]
