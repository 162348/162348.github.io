...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, arc=.35mm, rightrule=.15mm, colback=white, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, breakable, leftrule=.75mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, arc=.35mm, rightrule=.15mm, colback=white, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, breakable, leftrule=.75mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, coltitle=black, title={注（TeX Live のアップデート方法）}, colbacktitle=quarto-callout-important-color!10!white, colback=white, colframe=quarto-callout-important-color-frame, breakable, arc=.35mm, left=2mm, toptitle=1mm, opacitybacktitle=0.6, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm]
