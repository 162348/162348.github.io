...
* [Zig-Zag サンプラー](../../2024/Computation/ZigZag.qmd) など，HTML とスライド (reveal.js) の両方で見れるページ
* 本ページなど，HTML とスライド (pptx) と PDF と reveal.js のさまざまで見れるページ

:::

Quarto ではこのような多様なドキュメントが，極めて簡単に＋凡ゆるフォーマットで作成できる．
