...
[教科書](../../../static/Sessions.qmd#sec-法律家のための統計数理) [@草野2016] では 1.を $\bigcirc$ で，2.を $\square$ で表している．
...
[教科書](../../../static/Sessions.qmd#sec-法律家のための統計数理) [@草野2016] では「効用」という概念を金銭的利得と関連付けて説明しているが，そのためにわかりにくい提示の仕方になっている．^[加えて，p.55 に「上記の公理からの演繹的推論によって次の結論が導き出される」とあるが，これは「効用」「単調増加」などの未定義用語を含むため，「演繹的推論によって」というのは誤謬というべきである．]
...
$$
1. （アルキメデス性）^[[教科書](../../../static/Sessions.qmd#sec-法律家のための統計数理) [@草野2016] では「連続性」とあったが，ここでは [@vonNeumann-Morgenstern1944] の原著に従う．] 任意の $x,y,z\in X$ に対して，$x\succsim y\succsim z$ ならば，ある $\al,\beta\in(0,1)$ が存在して，
$$
...
[教科書](../../../static/Sessions.qmd#sec-法律家のための統計数理) [@草野2016] にいう「期待効用定理」とはこの定理を指すものと思われる．この $u\in C_b(\R)$ を **効用関数** (utility function) という．
