...
code-fold: true
abstract-title: 概要
abstract: 教科書）第３章第１節から第４節 (pp. 73-96) を通じ，統計学検定への入門も兼ねて，推測統計学の基礎を学ぶ．
crossref:
    sec-prefix: 節
    eq-prefix: 式
---
...
詳しくは [本サイトの数学記法一覧](../../Surveys/Notations.qmd#sec-probability-space) を参照．
