...
plt.figure(figsize=(3, 2))
plt.plot(data['日平均'], label='データ', linestyle='', marker='.')
plt.plot([m['mean'] for m in PF1.summaries.Moments], label='濾波して得たトレンド')
plt.legend()
plt.show()
```
...
plt.figure(figsize=(3, 2))
plt.plot(data['日平均'], label='データ', linestyle='', marker='.')
plt.plot([m['mean'] for m in PF4.summaries.Moments], label='濾波して得たトレンド')
plt.legend()
plt.show()
```
...
plt.figure(figsize=(3, 2))
plt.plot(data['日平均'], label='データ', linestyle='', marker='.')
plt.plot([m['mean'] for m in PF2.summaries.Moments], label='濾波して得たトレンド')
plt.legend()
plt.show()
```
...
plt.figure(figsize=(3, 2))
plt.plot(data['日平均'], label='データ', linestyle='', marker='.')
plt.plot([m['mean'] for m in PF3.summaries.Moments], label='濾波して得たトレンド')
plt.legend()
plt.show()
```
...
plt.figure(figsize=(3, 2))
plt.plot(data['日平均'], label='データ', linestyle='', marker='.')
plt.plot(filtered_state_means, label='濾波して得たトレンド')
plt.legend()
plt.show()
```
...
plt.figure(figsize=(3, 2))
plt.plot(data['日平均'], label='データ', linestyle='', marker='.')
plt.plot(smoothed_state_means, label='平滑化して得たトレンド')
plt.legend()
plt.show()
```
