...
$$
3. さらに $\{Y_n\}_{n=1}^\infty$ が独立であるならば，$\{X_n\}_{n=0}^\infty$ と $\{(X_n,T_{n-1})\}_{n=1}^\infty$ はいずれも Markov 過程である．
4. さらに $\{Y_n\}_{n=1}^\infty$ が同分布であるならば，Markov 過程 $\{X_n\}_{n=0}^\infty$ と $\{(X_n,T_{n-1})\}_{n=1}^\infty$ は時間的に一様である．
:::
