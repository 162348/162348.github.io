...
3. $(Y_k)_{k=1}^\infty$ が独立であるとき，$(X_k)_{k=0}^\infty$ も独立である．これより，任意の時点 $m_1<\cdots<m_k<n\in\N$ について，$T_{m_k-1}$ が与えられた下で，$X_k\;(k\ge m_k)$ と $\F_{m_k-1}$ とは独立である．よって特に，$(X_{m_k},T_{m_k-1})$ が与えられた下で，$(X_n,T_{n-1})$ と $(X_{m_i},T_{m_i-1})\;(i<k)$ とは独立である．よって，^[[@Kallenberg21-Foundations pp.170-171] 定理8.9 Doob's conditional independence を参考にした．]
$$
\begin{align*}
