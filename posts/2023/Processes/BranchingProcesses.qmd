...
それ以外の場合は，第 $n$ 世代（個体数 $Z_n$）を構成する個体がそれぞれ $Y_{T_{n-1}+i}\;(i=1,\cdots,Z_n)$ 人の家族を遺して消滅し，これら子孫が第 $n+1$ 世代 $Z_{n+1}$ を構成する．
...
1. 任意の $n\in\N^+$ について $\E[Y_{n+1}|Y_1,\cdots,Y_n]=a$ ならば，
$$
\E[X_{n+1}|\F_n]=aX_n^+,\quad n\in\N.
$$
:::
...
\begin{align*}
    ...
    &=\Brace{\forall_{j\in[n-1]}\;T_j=i_j,X_n=r_n}=:B_n
\end{align*}
$$
$$
