...
[@Dudley02-RealAnalysisAndProbability 10.1節 p.336], [@吉田朋広-数理統計 p.43] がおすすめな参照先．[@舟木-確率論 p.88] が入門しやすい．$X\in L^2(\Om)$ でいい場合は，より「射影」としてわかりやすい特徴付けがある（ @sec-characterization ）．これのおすすめは [@Jacod-Protter2004 第23節 p.200], [@Kallenberg21-Foundations p.164]．
