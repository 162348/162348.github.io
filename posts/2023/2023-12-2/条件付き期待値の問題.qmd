...
[@Dudley02-RealAnalysisAndProbability 定理4.2.8 p.128] は $S=\R$ の場合，[@Landkov72-Probability] は $S=\R^m$ の場合, [@Kallenberg21-Foundations 補題1.14 p.18] に一般の標準Borel空間の場合の証明がある．
...
$$
=\frac{\E[1_{\Brace{Y\in B}}1_{\Brace{X=x}}]}{\P[X=x]}=\frac{\P[Y\in B,X=x]}{\P[X=x]}
$$
という見慣れた表示を得る．