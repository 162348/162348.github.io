...
### 先行研究：Zig-Zag v. BPS [[@Bierkens+2020]]{.small-letter}
...
### BPS の大域的リフレッシュ動作 {#sec-global-refresh}
...
::: {.column width="33%"}
![](ISM/BPS_10.0_Trajectory_.gif)
:::

::::

### 説明したいもの：Zig-Zag v. BPS v. FECMC {#sec-comparison}
...
→ $d$ が大きいほど，$\sigma^2$ の値を知るのに，$\wh{g}^d_T$ を使った方が有利？

$$
\wh{g}_T:=\frac{1}{T}\int^T_0g(X_t,V_t)\,dt=\frac{1}{T}\int^T_0R_t\,dt.
$$

### 実験結果 {#sec-asymptotic-variance-experiment}

![](ISM/AsymptoticVariance.svg){fig-align="center"}
