...
この潜在変数解釈は容易に２値応答以外の場合に拡張できる．その結果多項モデルを用いたソフトマックス回帰 [-@sec-softmax-regression] などとは別のアプローチが，多値順序応答に対して可能になる．
...
これを順序ロジスティック回帰 (ordinal / ordered logistic regression) [@McCullagh1980] という [@Kruschke2015 p.671]．
