...
$$
の最大化によって $M$-推定することが考えられる．^[一方で，重み付き推定方程式として理解することもできる．[5.2節 @高井啓二+2016 p.163]．] ただし，$w_i$ は $Y$ の計画一致性を持つ校正推定量を定める校正荷重であるとする．
...
特に公的統計においては，後続のタスクが One Number Principle に従うようにするために欠測のあるデータは代入してしまうこともあり得る [Section 13.1 @Kim2024 p.161]．
