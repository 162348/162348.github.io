...
::: {.callout-tip appearance="simple" icon="false" title="What We'll Learn in the Rest of this Section"}
...
Reversibility is regarded as one of the main causes of slow mixing of [MH]{.color-unite}. It is also termed as 'diffusive behavior.' [See, e.g., @Andrieu-Livingstone2021]
...
{{< fa arrow-right >}} Inverting $M$ will be still more difficult, or even impossible.
...
## Proof of Concept {#sec-ProofOfConcept}
...
## Appendix: Application to Imbalanced Logistic Regression {visibility="uncounted"}
