...
欠測データ (incomplete data) とは，２つの確率変数 $(X,Y)$ について次の図式が成り立つ際の，$X$ を潜在変数として，$Y$ からの観測とみなせるデータをいう [@Dempster+1977 p.1]：

![Hidden State Model](incomplete.png)
