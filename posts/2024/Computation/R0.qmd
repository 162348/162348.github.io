...
R 言語とは
  ...
  * 最新の技術や方法が簡単に導入できることも多い 
      ...
      * PythonやJuliaと同様．
  * Austriaの人中心の開発．データの分類・集計・整理の機能は織り込み済み．
      * ニュージーランドのオークランド大学のRoss IhakaとRobert Clifford Gentlemanにより作られた
      * BBCのグラフはRで書いている．BBCがR用のパッケージをリリースしている．
  * R project
...
* polymorphic な関数を generic functionという．^[`c++`ならば仮想関数という．]
