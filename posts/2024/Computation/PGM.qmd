...
[決定木](../../2023/数理法務/%E6%B3%95%E5%BE%8B%E5%AE%B6%E3%81%AE%E3%81%9F%E3%82%81%E3%81%AE%E7%B5%B1%E8%A8%88%E6%95%B0%E7%90%863.qmd)，[状態空間モデル](../../2023/Surveys/SSM.qmd) はいずれもベイジアンネットワークの例である．^[[@Taroni+2014 p.35]，[@Sucar2021 p.x]]

（２次元以下の）[Ising 模型](PGM2.qmd#sec-Ising-model) はマルコフネットワークの例である．

以上は全て，確率的グラフィカルモデルの例である．

[@Wainwright-Jordan2008], [@Chen2023]
...
Bayesian network は belief network とも呼ばれる．^[[@Li2009 p.48]．[Wikipedia](https://en.wikipedia.org/wiki/Bayesian_network) も参照．] 決定分析で用いられる [influence diagram](https://en.wikipedia.org/wiki/Influence_diagram) / decision network はその一般化である．
