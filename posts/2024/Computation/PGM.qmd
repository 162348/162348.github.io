...
マルコフネットワークは，２次元のマルコフ確率場に等価である．^[[@Li2009 p.47] は，pairwise なマルコフ確率場もマルコフネットワークと見れることを指摘している．pairwise とは非零なポテンシャルを持つクリークが二点集合になるマルコフ確率場をいう．]
...
[@Besag1974] はこの定理に別証明を付し，植物生態学における空間統計モデルに応用している．

また，Markov 確率場の結合分布を，Gibbs 分布を通じて計算することができることは，統計的画像解析という新たな分野を拓いた [@Grenander1983]．これを通じて，ギブス・サンプラーの開発 [@Geman-Geman1984] に繋がった．^[[@Li2009 p.1]．]
