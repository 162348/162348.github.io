...
これは希薄気体の熱力学を，ミクロの対象に関する密度関数の時間変化を記述することで基礎付けたもので，この接近を一般に **運動論的方法** (kinetic method) という．^[[@戸田+2011 p.vi]．「ミクロの対象」と言ったが，Maxwell がこの理論を展開した当時は原子論もまだ仮説の一つに過ぎなかった [@Villani-Mouhot2015 p.3]．]

この手法がそのまま統計熱力学一般の基礎付けとはならず，その抽象的な枠組みは，後に [@Gibbs1902] によって与えられた．
