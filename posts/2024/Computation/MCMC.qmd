...
::: {layout-ncol=2}
![分子動力学法の出力](../../../docs/posts/2024/Computation/MCMC_files/figure-html/fig-md-output-1.png)

![Metropolis 法の出力](../../../docs/posts/2024/Computation/MCMC_files/figure-html/fig-mh-output-1.png)
:::

これを基礎として，近年提案された非対称な MCMC 手法（第 [-@sec-LMH] 章），そして最新の連続時間 MCMC 手法（第 [-@sec-PDMP] 章）を紹介します．

::: {layout-ncol=2}
![非対称 MCMC 法（Lifted Metropolis 法）の出力](../../../docs/posts/2024/Computation/MCMC_files/figure-html/fig-lmh-output-1.png)

![連続時間 MCMC 法（Zig-Zag サンプラー）の出力](../../../docs/posts/2024/Computation/MCMC_files/figure-html/fig-pdmp-output-1.png)
:::
...
![@fig-1 Metropolis 法の軌跡](../../../docs/posts/2024/Computation/MCMC_files/figure-html/fig-mh-traj-output-1.png){width=230pt}
