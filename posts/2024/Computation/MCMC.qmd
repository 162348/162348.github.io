...
上図は Metropolis 法で構成される Markov 連鎖の軌跡を表しています．行ったり来たりしているのがわかります．棄却率は $1/4$ 程度です．^[一般には，採択率の方を $1/4$ から $1/2$ にするのが良いとされています．[@Chopin-Papaspiliopoulos20-SMC p.282] など．]
...
これは，一度「この方向に行く！」と決めたら行き続けるようにしたことが関係していると考えられます．
...
自己相関関数は，Lifted Metropolis-Hastings 法と同様に，急激に下がって負の値に突き抜けたあとは，Lifted Metropolis-Hastings 法よりも急速に減衰していることがわかります．
