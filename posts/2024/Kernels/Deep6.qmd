...
このモデル $\{f(w)_*p_z\}_{w\in\cW}$ の尤度は解析的に表示できない．そこで，[GAN](Deep3.qmd) [@Goodfellow+2014] は敵対的な学習規則を用いれば，尤度の評価を回避できるというアイデアに基づくものであり，[VAE](Deep4.qmd) [@Kingma-Welling2014] は変分近似を通じて尤度を近似するというものであった．
