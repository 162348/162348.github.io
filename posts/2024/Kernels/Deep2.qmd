...
自然言語処理にトランスフォーマーを応用した例は大きな成功を見ている．GPT [@Radford+2018], GPT-2 [@Radford+2019], GPT-3 [@Brown+2020], GPT-4 [@OpenAI2023] のシリーズはその代表であり，特に GPT-4 は AGI の実現に向けた重要な一歩とも評されている [@Bubeck+2023]．^[他にも Google の [GShard](https://research.google/pubs/gshard-scaling-giant-models-with-conditional-computation-and-automatic-sharding/) [@Lepikhin+2021]，[PaML](https://japan.googleblog.com/2023/05/palm-2.html) [@Chowdhery+2022]，Google Brain の Switch Transformers [@Fedus+2022]，Google DeepMind の [Gopher](https://deepmind.google/discover/blog/language-modelling-at-scale-gopher-ethical-considerations-and-retrieval/) [@Rae+2021] などがある．]
...
[@Lewis+2020] はこの検索器を BART [@Lewis+2020-BART] に接続した．
...
GPT-3 [@Brown+2020] と [ImageGPT](https://openai.com/research/image-gpt) [@Chen+2020] とは殆ど同じモデルを用いている．これらを組み合わせて作られたのが [DALL-E](https://openai.com/research/dall-e) [@Ramesh+2021] である．
...
OpenAI の [CLIP](https://openai.com/research/clip) [@Radford+2021] は画像から概念を学習する視覚モデルである．
