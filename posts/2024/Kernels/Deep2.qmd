...
::: {.callout-caution icon="false" collapse="true" title="種々の LLM"}
...
GPT-3 [@Brown+2020] と [ImageGPT](https://openai.com/research/image-gpt) [@Chen+2020] とは殆ど同じモデルを用いている．これらを組み合わせて作られたのが [DALL-E](https://openai.com/research/dall-e) [@Ramesh+2021] である．^[すなわち，DALL-E は GPT-3 のマルチモーダルな実装である [@Tamkin+2021 p.4]．]
...
生成 AI は，一国の政府が特定のプロパガンダを流布するための効果的な手段として選ばれることになる．これに対する対策が考えられてる [@Goldstein+2023]．
