...
DeepMind の [Perceiver](https://deepmind.google/discover/blog/perceiver-ar-general-purpose-long-context-autoregressive-generation/) [@Jaegle+2021] は画像，動画，音声を１つのモデルで扱う．
...
[潜在拡散モデル](Deep5.qmd#sec-idea) で [U-Net](Deep.qmd#sec-U-net) [@Ronneberger+2015] を用いていたところをトランスフォーマーに置換した DiT (Diffusion Transformer) [@Peebles-Xie2023] が発表された．
...
OpenAI は 2/15/2024 に [Sora](https://openai.com/sora) [@Brooks+2024] を発表した．
