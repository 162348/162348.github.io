...
この形の分布族を **正準分布** または **Gibbs 分布** [@Koller-Friedman2009 p.108], [@Friedli-Velenik2017 p.25]，または **Boltzmann 分布** [@Kim-Bengio2016], [@Mezard-Montanari2009 p.23] ともいう．^[ ということもあるようであるが，物理の用語では $e^{H(z)}$ を Boltzmann 因子と呼ぶのみであるようである [@田崎晴明2008 p.107]．]
