---
title: "新時代の MCMC 環境に向けて"
subtitle: "`PDMPFlux.jl` パッケージの使い方"
author:
  - name: "司馬博文"
date: "10/29/2024"
...
format:
  ...
  revealjs: 
    ...
    footer: |
      [司馬博文](https://162348.github.io/posts/2024/Slides/PDMPFlux.html)
    scrollable: true
    smaller: false
    controls: true
...
description: |
  スライドは<a href="https://162348.github.io/posts/2024/Computation/PDMPFlux_Slides.html" style="text-decoration: underline;">こちら</a>．
...
abstract: |
  本郷キャンパスにて発表．
  スライドは[こちら](https://162348.github.io/posts/2024/Computation/PDMPFlux_Slides.html)．
---
