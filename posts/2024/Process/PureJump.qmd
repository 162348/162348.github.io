...
::: {.callout-tip icon="false" #tip-problem}
...
> the class of "piecewise-deterministic" Markov processes, newly introduced here, provides a general family of models covering virtually all non-diffusion applications. [@Davis1994]
