...
::: {.callout-tip title="定義 ($K$-marked process)^[[@Last_Penrose2017 p.40] 定義5.3 に倣った．[@Kingman1992 p.55] 5.2節や [@Bremaud1981 p.233] も参照．]" icon="false"}
...
::: {.callout-caution title="例（待ち行列過程）" collapse="true" icon="false"}

顧客が特定のタイミング $T_n$ でのみ到着するとした場合，その際の人数 $N_n$ との組 $(T_n,N_n)$ は付印 Poisson 過程としてモデル化できる [@Bremaud1981 p.233 例3]．
