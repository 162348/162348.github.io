...
function plot_2dtraj(traj; title="ZigZag Sampler")
    # trajからx座標とy座標を抽出
...
function plot_1dtraj(traj; title="ZigZag Sampler")
...
plot_1dtraj(traj, title="1D ZigZag Sampler (Cauchy distribution)")
```
