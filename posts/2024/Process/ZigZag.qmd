...
<div class="article-card-container">
    <div class="article-card">
        <a href="https://162348.github.io/posts/2024/Stat/ZigZagSubsampling.html" target="_blank">
            <img src="https://162348.github.io/posts/2024/Process/MeanOfGaussian.svg" alt="Article Image" class="article-image">
            <div class="article-content">
                <h3 class="article-title">Zig-Zag サンプラーのサブサンプリングによるスケーラビリティ</h3>
                <p class="article-description">大規模モデル・大規模データに対する MCMC を目指して</p>
            </div>
        </a>
    </div>
</div>
...
plot_2dtraj(traj, title="2D ZigZag Sampler (Gaussian Distribution)"; save=true, label="ZigZag2D_Gaussian")
```