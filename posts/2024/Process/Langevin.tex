...
\usepackage{luatexja}
\usepackage{footnote}\title{Langevin Dynamics の多項式エルゴード性}
\author{司馬 博文}
\date{7/05/2024}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, arc=.35mm, toprule=.15mm, bottomrule=.15mm, rightrule=.15mm, left=2mm, colframe=quarto-callout-tip-color-frame, breakable, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomrule=.15mm, toptitle=1mm, breakable, colback=white, opacitybacktitle=0.6, bottomtitle=1mm, titlerule=0mm, title={証明}, colframe=quarto-callout-note-color-frame, left=2mm, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, bottomrule=.15mm, toptitle=1mm, breakable, colback=white, opacitybacktitle=0.6, bottomtitle=1mm, titlerule=0mm, title={{[}@Lawler2019 p.10 命題2.5{]}}, colframe=quarto-callout-tip-color-frame, left=2mm, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, bottomrule=.15mm, toptitle=1mm, breakable, colback=white, opacitybacktitle=0.6, bottomtitle=1mm, titlerule=0mm, title={命題}, colframe=quarto-callout-tip-color-frame, left=2mm, rightrule=.15mm, opacityback=0]
...
\footnotetext{\(\operatorname{E}_x\biggl[1_{[0,\tau_n]}(t)\widehat{L}G(X_t)\biggr]\to\operatorname{E}_x[\widehat{L}G(X_t)]\)
の収束が広義一様に起こるためである． \begin{align*}
...
\end{align*} ここで \(t\mapsto\widehat{L}G(X_t)\)
...
\frac{\partial }{\partial t}\operatorname{E}_x[G(X_{t\land\tau_n})]\xrightarrow{n\to\infty}\frac{\partial }{\partial t}\operatorname{E}_x[G(X_t)]
\] の広義一様収束が必要になる．

\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, bottomrule=.15mm, toptitle=1mm, breakable, colback=white, opacitybacktitle=0.6, bottomtitle=1mm, titlerule=0mm, title={{[}@Rudin-Principles p.152 定理7.17{]}\footnote{{[}@杉浦光夫1980
  p.311{]} 定理13.7系では，\(f_n\) に \(C^1\)-級の仮定を置いている．}}, colframe=quarto-callout-tip-color-frame, left=2mm, rightrule=.15mm, opacityback=0]
...
いま，\(\operatorname{E}_x[G(X_t)]<\infty\) の仮定から，Lebesgue
の優収束定理より， \[
\operatorname{E}_x[G(X_{t\land\tau_n})]\to\operatorname{E}_x[G(X_t)]
\] である．加えて，導関数もある関数に一様収束する： \[
\lim_{n\to\infty}\frac{\partial }{\partial t}\operatorname{E}_x[G(X_{t\land\tau_n})]=\operatorname{E}_x[\widehat{L}G(X_t)].
\]

これより，\(\operatorname{E}_x[G(X_t)]\) も可微分で， \[
\frac{\partial }{\partial t}\operatorname{E}_x[G(X_t)]=\operatorname{E}_x[\widehat{L}G(X_t)]
\] が成り立つ．
