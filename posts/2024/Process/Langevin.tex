...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, breakable, toprule=.15mm, left=2mm, colback=white, opacitybacktitle=0.6, opacityback=0, toptitle=1mm, titlerule=0mm, title={{[}@Lawler2019 p.10 命題2.5{]}}, arc=.35mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, bottomrule=.15mm, coltitle=black, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, breakable, toprule=.15mm, left=2mm, colback=white, opacitybacktitle=0.6, opacityback=0, toptitle=1mm, titlerule=0mm, title={命題 \ref{sec-extended-generator}}, arc=.35mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, bottomrule=.15mm, coltitle=black, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, breakable, toprule=.15mm, left=2mm, colback=white, opacitybacktitle=0.6, opacityback=0, toptitle=1mm, titlerule=0mm, title={{[}@Rudin-Principles p.152 定理7.17{]}\footnote{{[}@杉浦光夫1980
  p.311{]} 定理13.7系では，\(f_n\) に
  \(C^1\)-級の仮定を置いて，この場合は \(f\) が
  \(C^1\)-級になることを導いている．}}, arc=.35mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, bottomrule=.15mm, coltitle=black, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white]
