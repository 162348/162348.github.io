...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacityback=0, left=2mm, rightrule=.15mm, arc=.35mm, colframe=quarto-callout-tip-color-frame, colback=white, bottomrule=.15mm, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, rightrule=.15mm, coltitle=black, colback=white, titlerule=0mm, breakable, opacityback=0, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, title={証明}, bottomrule=.15mm, toprule=.15mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, rightrule=.15mm, coltitle=black, colback=white, titlerule=0mm, breakable, opacityback=0, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, title={{[}@Lawler2019 p.10 命題2.5{]}}, bottomrule=.15mm, toprule=.15mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, rightrule=.15mm, coltitle=black, colback=white, titlerule=0mm, breakable, opacityback=0, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, title={命題 \ref{sec-extended-generator}}, bottomrule=.15mm, toprule=.15mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, rightrule=.15mm, coltitle=black, colback=white, titlerule=0mm, breakable, opacityback=0, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, title={{[}@Rudin-Principles p.152 定理7.17{]}\footnote{{[}@杉浦光夫1980
  p.311{]} 定理13.7系では，\(f_n\) に
  \(C^1\)-級の仮定を置いて，この場合は \(f\) が
  \(C^1\)-級になることを導いている．}}, bottomrule=.15mm, toprule=.15mm, toptitle=1mm]
