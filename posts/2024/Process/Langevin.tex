...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, arc=.35mm, left=2mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, breakable, opacityback=0, colback=white, bottomrule=.15mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, toptitle=1mm, titlerule=0mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, breakable, opacityback=0, coltitle=black, bottomtitle=1mm, title={証明}, toprule=.15mm, opacitybacktitle=0.6]
