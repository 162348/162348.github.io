...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, colback=white, colframe=quarto-callout-tip-color-frame, leftrule=.75mm, toprule=.15mm, rightrule=.15mm, arc=.35mm, left=2mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, coltitle=black, title={証明}, opacityback=0, leftrule=.75mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, coltitle=black, title={{[}@Lawler2019 p.10 命題2.5{]}}, opacityback=0, leftrule=.75mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, coltitle=black, title={命題 \ref{sec-extended-generator}}, opacityback=0, leftrule=.75mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, coltitle=black, title={{[}@Rudin-Principles p.152 定理7.17{]}\footnote{{[}@杉浦光夫1980
  p.311{]} 定理13.7系では，\(f_n\) に
  \(C^1\)-級の仮定を置いて，この場合は \(f\) が
  \(C^1\)-級になることを導いている．}}, opacityback=0, leftrule=.75mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, left=2mm]
