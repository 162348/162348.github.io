...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colback=white, colframe=quarto-callout-tip-color-frame, arc=.35mm, bottomrule=.15mm, left=2mm, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, coltitle=black, arc=.35mm, rightrule=.15mm, leftrule=.75mm, breakable, opacityback=0, title={証明}, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, coltitle=black, arc=.35mm, rightrule=.15mm, leftrule=.75mm, breakable, opacityback=0, title={{[}@Lawler2019 p.10 命題2.5{]}}, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, coltitle=black, arc=.35mm, rightrule=.15mm, leftrule=.75mm, breakable, opacityback=0, title={命題 \ref{sec-extended-generator}}, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, coltitle=black, arc=.35mm, rightrule=.15mm, leftrule=.75mm, breakable, opacityback=0, title={{[}@Rudin-Principles p.152 定理7.17{]}\footnote{{[}@杉浦光夫1980
  p.311{]} 定理13.7系では，\(f_n\) に
  \(C^1\)-級の仮定を置いて，この場合は \(f\) が
  \(C^1\)-級になることを導いている．}}, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6]
