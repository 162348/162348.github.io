...
\begin{tcolorbox}[enhanced jigsaw, breakable, rightrule=.15mm, arc=.35mm, leftrule=.75mm, opacityback=0, colback=white, bottomrule=.15mm, left=2mm, colframe=quarto-callout-tip-color-frame, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomrule=.15mm, toptitle=1mm, colback=white, colframe=quarto-callout-note-color-frame, breakable, rightrule=.15mm, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, title={証明}, opacityback=0, left=2mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomrule=.15mm, toptitle=1mm, colback=white, colframe=quarto-callout-tip-color-frame, breakable, rightrule=.15mm, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, title={{[}@Lawler2019 p.10 命題2.5{]}}, opacityback=0, left=2mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomrule=.15mm, toptitle=1mm, colback=white, colframe=quarto-callout-tip-color-frame, breakable, rightrule=.15mm, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, title={命題 \ref{sec-extended-generator}}, opacityback=0, left=2mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomrule=.15mm, toptitle=1mm, colback=white, colframe=quarto-callout-tip-color-frame, breakable, rightrule=.15mm, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, title={{[}@Rudin-Principles p.152 定理7.17{]}\footnote{{[}@杉浦光夫1980
  p.311{]} 定理13.7系では，\(f_n\) に \(C^1\)-級の仮定を置いている．}}, opacityback=0, left=2mm, toprule=.15mm]
