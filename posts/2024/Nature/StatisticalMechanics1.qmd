...
EA 模型を無限レンジにすることで，平均場近似が厳密解を与えるようにし，これを解いたものである．その際にもレプリカ法が重要な手法として用いられた．
...
しかしこの模型は初め低温域では破綻を起こすとされていたが，[@Parisi1980] がこの問題を解決し，任意の温度 $T>0$ での厳密解が得られた．これは Parisi ansatz と呼ばれる．^[[@Panchenko2012] も参照．]
...
[@Minlos2000], [@西森秀稔2003], [@Altieri-Baity-Jesi2024], [@Chatterjee2023], [@Panchenko2012]