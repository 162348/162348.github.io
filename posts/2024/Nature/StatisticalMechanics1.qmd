...
古典粒子系を例にとって，統計力学における基本的な用語を確認する．
...
そのこともあり，物理系はグラフィカルモデル（Bayesian networks, Markov networks）としての表現と親和性があり，特に [**因子グラフ**](../Computation/PGM1.qmd#sec-Factor-Graph) も重要な形式として用いられる [@Mezard-Montanari2009 p.100]．
