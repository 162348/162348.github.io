...
大雑把に捉えれば，エネルギー一定の力学系の全ての状態の上の分布がミクロカノニカル分布であり，このエネルギーも動かした場合，各エネルギー上の分布はカノニカル分布になる．
...
そして熱力学極限において，これら３集団は等価であるから，これらはパラメータ変換の問題でしかなく，さらにこのパラメータ空間上に別の関数も導入される．特にエントロピー $s(e,\rho)$，Helmgolz の自由エネルギー（密度） $f(\beta,\rho)$，圧力 $p(\beta,\mu)$ などであり，これらは互いに Legendre 変換により関係し合っている．
...
[@Minlos2000], [@西森秀稔2003], [@Baxter1982]