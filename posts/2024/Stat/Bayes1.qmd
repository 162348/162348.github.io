...
\begin{align*}
    ...
    &=\E\SQuare{\log\paren{\int_\R \exp\paren{-\frac{x^2}{2\sigma^2}+\frac{xZ}{\sigma}+\frac{xX^*}{\sigma^2}}}}\\
    &=\E\SQuare{\log\paren{\int_\R \exp\paren{-x^2\frac{\beta^2}{2}+xZ\beta+xX^*\beta^2}}}.
\end{align*}

こうして，最右辺の期待値に関する密度はもう $\beta$ に依存しないから，次のように微分が計算できる：
