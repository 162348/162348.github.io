...
@load "Logistic2_Experiment1_Archived.jld2" ESS_Affine var_ESS_Affine ESS_Global var_ESS_Global
```
...
p = startPlot(n_list, ESS_Global, sqrt.(var_ESS_Global))
...
#| echo: false
#| output: false
@load "Logistic2_Experiment2_Archived.jld2" ESS_CV var_ESS_CV ESS_SS var_ESS_SS
```
