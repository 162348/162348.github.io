...
このとき，Edwards-Anderson モデルは $\beta=\beta^*$ （式 [-@eq-Nishimori-temperature]）の場合に限り，内部エネルギーが厳密解を持つ．^[[@Nishimori1980] の報告である．[@西森秀稔1999 pp.53-]，[@Iba1999 p.3879] 式 (25) も参照．] 例えば，平均次数 $c$ を持つランダムグラフ上の Edwards-Anderson モデルの西森温度における内部エネルギーは
$$
