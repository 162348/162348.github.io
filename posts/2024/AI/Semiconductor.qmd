...
しかし真に大量生産可能にし，半導体産業を大きくしたのは [@Noyce1959] の発明であった．
...
集積回路における支配的な技術である．その秘訣は消費電力の少なさにあり，トランジスタの $0,1$ の切り替えの際に生じる電力（動的エネルギー）のみが消費される．^[[@Patterson-Hennessy2014 p.41]．] 
