...
```{=html}
<iframe class="slide-deck" src="Semiconductor_slides.html" href="Semiconductor_slides.html"></iframe>
```
...
![[チップの断面構造](https://www.hitachi-hightech.com/jp/ja/knowledge/semiconductor/room/about/ic.html)](chip.png)
...
これをウエハに転写するには，[フォトリソグラフィ](https://ja.wikipedia.org/wiki/%E3%83%95%E3%82%A9%E3%83%88%E3%83%AA%E3%82%BD%E3%82%B0%E3%83%A9%E3%83%95%E3%82%A3) (Photolithography) を用いる．

製造については次節[-@sec-manufacturing]で詳しく解説する．
...
5. 配線層形成
    ...
    基本３工程を繰り返すことで，トランジスタ層上を分厚い配線層で覆う．
...
[DRAM (Dynamic RAM)](https://ja.wikipedia.org/wiki/Dynamic_Random_Access_Memory) [@Dennard1968] はチップ内にコンデンサを備えており，１つのコンデンサで１ビットを表現する．これを読み出すのに１つのトランジスタ [MOSFET](https://ja.wikipedia.org/wiki/MOSFET) を使うのみであるから，SRAM に比べて安価であるが，電荷は時間と共に散逸するため，定期的にリフレッシュする必要があり，消費電力は大きい．^[[@Sze-Lee2012 p.8]，[@Patterson-Hennessy2014 p.379] 参照．]

![From [@Patterson-Hennessy2014 p.380]](DRAM.png)
