...
[![雑音除去拡散過程](Files/unnormalized_target.svg)](DD1.qmd)
...
|:----:|:----:|:---:|
| [雑音除去拡散モデル](DD1.qmd#sec-DDOS) | [{{< fa xmark >}}]{.color-blue} | [{{< fa xmark >}}]{.color-blue} |
| [Schrödinger 橋による改良](DD1.qmd#sec-DSB-PS) | [{{< fa xmark >}}]{.color-blue} | [{{< fa check >}}]{.color-red} |
