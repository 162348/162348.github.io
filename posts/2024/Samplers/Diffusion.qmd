...
この方法は，OU 過程をデータ分布に誘導するスコア場を，種々のノイズレベル $\sigma_t>0$ [スコアマッチング](EBM.qmd#sec-SM) により学習し，アニーリング Langevin サンプラーによりサンプリングをしていることに等価になる．

このスコアベースの生成モデルとしての見方については，次の第 [-@sec-SGM] 節で詳しく述べるが，この２つの見方はノイズスケジュールの違いを除いて等価な目的関数を定める [@Huang+2021]．
