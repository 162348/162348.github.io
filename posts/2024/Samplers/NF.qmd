...
正規化流 (NF: Normalizing Flow) とは [@Tabak-Vanden-Eijnden2010] が提案・造語した生成モデリングアプローチであり，ニューラルネットワークとしては画像生成を念頭に NICE [@Dinh+2015]（のちに Real NVP [@Dinh+2017]）がはじめに提案された．
...
$$
を通じて，$\Tr(J_F^k)$ が Hutchinson の跡推定量 [@Hutchinson1990] により，その無限和が Russian-roulette 推定量 [@Skilling1989] により不偏推定できる [@Chen+2019]．
...
[@Tabak-Vanden-Eijnden2010], [@Tabak-Turner2013] が正規化流の提案と命名を行った．