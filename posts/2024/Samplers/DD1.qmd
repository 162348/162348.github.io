---
title: "雑音除去拡散過程"
subtitle: "Denoising Diffusion から Denoising Schrödinger Bridge へ"
author: "司馬 博文"
date: 8/3/2024
...
abstract-title: 概要
abstract: 拡散モデルから始まるフロー学習手法は，画像と動画に関して 2024 年時点で最良の性能を誇る．本稿では，これを統計アルゴリズムとして用いるための方法を考える．生成モデリングを２つの密度の補間問題と捉えると，Denoising Diffusion モデルは良いモデルとは言えない．ここでは Schrödinger 橋を用いた，より正確な推定法を考える．
listing: 
...
| [DDS](DD2.qmd#sec-DDGS)（[次稿](DD2.qmd)） | [{{< fa check >}}]{.color-red} | [{{< fa xmark >}}]{.color-blue} |
| [DSBS](DD2.qmd#sec-DSB-GS) （[次稿](DD2.qmd)） | [{{< fa check >}}]{.color-red} | [{{< fa check >}}]{.color-red} |
...
SB はエントロピー正則化最適輸送の解になるが，このエントロピーの言葉で帰納バイアスを入れることができる [@Koshizuka-Sato2023], [@Isobe+2024]．
