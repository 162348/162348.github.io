...
\begin{align*}
    ...
    &\quad+\sum_{n=1}^N\frac{1}{2}\sum_{i,j=1}^d(\sigma\sigma^\top)_{ij}(x^n)\pp{^2f}{x^n_i\partial x^n_j}(x)\\
...
\begin{align*}
    ...
    &\quad+\frac{1}{2}\sum_{i,j=1}^d(\sigma\sigma^\top)_{ij}(x)\pp{^2f}{x_i\partial x_j}(x)
\end{align*}
$$
$$
