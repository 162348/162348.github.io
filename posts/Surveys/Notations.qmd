...
* 確率空間 $(\Om,\F,\P)$ 上の [**フィルトレーション**](https://ja.wikipedia.org/wiki/%E6%83%85%E5%A0%B1%E7%B3%BB) $(\F_t)_{t\in\R_+}$ とは，右連続性
$$
...
* 確率空間 $(\Om,\F,\P)$ 上のフィルトレーション $(\F_t)_{t\in\R_+}$ が完備性
$$
\cN(\P)\subset\F_0
$$
を満たすとき，4-組 $(\Om,\F,(\F_t),\P)$ を [**確率基底**](https://encyclopediaofmath.org/wiki/Stochastic_basis) という．^[右連続性と完備性を併せて，フィルトレーション付き確率空間 $(\Om,\F,(\F_t),\P)$ の **通常の条件** ともいう．[@Protter2005 p.3] など参照．]



### 停止時^[[@Dellacherie-Meyer1978] 49 115-IV では **随意時刻** (optional time) とも呼んでおり，stopping time を older terminology ともしている．筆者も optional time の語がしっかり普及すれば良かったのにと思う．]
