...
* 可測空間 $(E,\cE)$ 上の **確率測度** の全体を $\cP(E,\cE)$ と書く．$E$ が位相空間であるとき，Borel 確率測度の全体を $\cP(E)$ と略記する．^[[@Crisan-Doucet2002], [@Ethier-Kurtz1986 p.96], [@Bogachev2007 p.228] に一致する．[@Kechris1995 p.109], [@Villani2009] はイタリックで $P(E)$ と表す．]
