...
* $(\Om,\F,\rP)$ を標準的な **確率空間** とする．^[[@Nualart2018-Introduction] に倣った．[@Gine-Nickl2021], [@Dudley2002] では $\mathrm{Pr}$ と表している．[@Villani2009] などは $\mathbb{P}$ で表す．] よって，明示せずとも，確率変数 $X$ と言ったときは $\L(\Om,\F,\rP)$ の元とする．
