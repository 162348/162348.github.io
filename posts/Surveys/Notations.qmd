...
\end{align*}
$$
で定める．^[[@Kallenberg2017 p.16] の呼び方に従った．[@Gikhman-Skorokhod2004I p.79] では **直積** と呼ばれており，p.76 定理II.4.1 でその存在が示されている．]
