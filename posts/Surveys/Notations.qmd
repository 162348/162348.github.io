...
$$\P^X:=X_*\P\in\cP(\X)$$
で表し，これを $X$ の **分布** という．^[[@伊藤清1991-確率論 p.125] に従った．ここでは **像測度** と **確率法則** と呼んでいる．像測度の呼び名は [@Bogachev2007 p.190] 3.6節, [@Kechris1995 p.103], [@Villani2009] にも一致する．[@Bogachev2007 p.190] では $\P\circ X^{-1}$，[@Villani2009] では $X_\#\P$ と表す．[nLab](https://ncatlab.org/nlab/show/pushforward+measure) も参照．]
