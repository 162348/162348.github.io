...
$$
となり，$p=2$ の場合は $\abs{x}:=\norm{x}_2$ とも表す．^[[@Evans2010 p.699], [@Jacob2001 p.xvi] に倣った．]
...
* 有界作用素の全体を $B(E,F)$ で表す．^[[@Pedersen1989 p.44], [@Jacob2001 p.xvii] に倣った．[@藤田+1991 p.106] では $\L(X,Y)$ と表す．] $B(E):=B(E,E)$ とする．
