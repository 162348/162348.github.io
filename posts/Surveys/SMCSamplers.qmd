...
この tempering という考え方は本質的に逐次的な発想を持っているが，元々は SMC の文脈とは全く独立に，MCMC を多峰性を持つ複雑な分布に対しても使えるように拡張する研究で提案され，**multilevel sampling** とも呼ばれた．^[[@Liu2004 pp.205-] Chapter 10. Multilevel Sampling and Optimization Methods も参照．] Multilevel sampling の発展の中で，次第に population-based と呼ばれる手法群 [@Iba2001] が発達し，自然と SMC が活躍の場を広げて行った，とも見れるのである．
