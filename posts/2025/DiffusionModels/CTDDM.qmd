...
When the state space is $E^d$ where $E=\{0,\cdots,K-1\}$ is finite, current practice is to learn a neural network $p_\theta$ based on a loss given by
$$
...
This is the idea behind the predictor-corrector technique proposed, for example, in [@Gat+2024], [@Zhao+2024], [@Zhao+2024Unified].
