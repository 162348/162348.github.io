...
### Generation from the Empirical Score
...
### 本論文の要旨：Implicit Dynamical Regularization
...
$n\in\{128,\cdots,32768\}$ を順に動かしていく
...
::: {.column width="50%"}
![スコア学習誤差のプロット^[$n$ が増えるほど汎化ギャップ $\mathcal{L}_{\text{gen}}=\mathcal{L}_{\text{test}}-\mathcal{L}_{\text{train}}$ が小さくなる．]<br>横軸：訓練 step 数 $\tau$，縦軸：訓練誤差（実線），テスト誤差（点線）．全て $t=0.01$．](Bonnaire2025/N2.png){fig-align="center" width="70%"}
:::
...
::: {.column width="50%"}
![$B=n$ と取った場合](Bonnaire2025/CelebA_B=n.png){fig-align="center" width="70%"}
:::

::: {.column width="50%"}
![SGD with momentum ではなく Adam を使った場合^[$\tau_{\text{gen}},\tau_{\text{mem}}$ が全体的に小さい方向へスライドする．]](Bonnaire2025/CelebA_Adam.png){fig-align="center" width="70%"}
:::
...
::: {.column width="50%"}
![](Bonnaire2025/N1.png){fig-align="center" width="70%"}
:::

::: {.column width="50%"}
![](Bonnaire2025/N2.png){fig-align="center" width="70%"}
:::
...
* NN の spectral bias [@Rahaman+2019] により低周波成分だけを学んでいることが汎化の主な理由である，という仮説がたつ．
