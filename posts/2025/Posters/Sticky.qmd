...
citation: true
poster: https://162348.github.io/posts/2025/Posters/StickyPDMP/ベイズ変数選択の計算的解決.pdf
...
[![クリックで PDF を表示](StickyPDMP/ベイズ変数選択の計算的解決.png)](StickyPDMP/ベイズ変数選択の計算的解決.pdf)
