...
非可逆なダイナミクスを持つ MCMC サンプラーとして期待されている手法は GHMC だけでない．PDMP (Piecewise Deterministic Markov Process) というクラスの Markov 過程に基づく，新種の MCMC 手法が近年提案されている [@Fearnhead+2018]．
