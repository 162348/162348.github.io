...
image: ./NewRegime/PDMPによりスパイク付きの非絶対連続分布からもサンプリングが可能.png
author: "司馬博文"
date: 3/8/2025
...
[![画像をクリックで PDF を表示](NewRegime/PDMPによりスパイク付きの非絶対連続分布からもサンプリングが可能.png){width="50%"}](NewRegime/PDMPによりスパイク付きの非絶対連続分布からもサンプリングが可能.pdf)
