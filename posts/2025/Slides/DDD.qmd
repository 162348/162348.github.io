...
### [New [Forward]{.color-unite} Paths and Corresponding [Backward]{.color-blue} ODEs]{.small-letter}
...
::: {.column width="33%"}
![](DDD/Lipman/2d_traj_diff.png)
:::

::: {.column width="33%"}
![](DDD/Lipman/2d_traj_ot.png)
:::
...
### Convergence of Masking Processes
