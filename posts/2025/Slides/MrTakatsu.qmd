...
::: {.column width="60%"}
![](MrTakatsu/cumfrac_m1_baseline_color.jpeg)
:::
::::
...
![](MrTakatsu/cumfrac_m1_covariate_color.jpeg)
...
* Overall accuracy: $\operatorname{Brier}(t)$ increased with time $\to$ worsening accuracy
* Calibration: Calibration slope $\approx0$ with instability over time.
...
* Discrimination: $\operatorname{AUC}(t)$ improve ($\approx0.70$)

* Overall accuracy: $\operatorname{Brier}(t)$ consistently lower than baseline model.

* Calibration: Calibration slope stabilized around 0.70 intercept $\approx 0$
